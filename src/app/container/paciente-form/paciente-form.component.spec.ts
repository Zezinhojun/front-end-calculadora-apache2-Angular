...
describe('PacienteFormComponent', () => {
      ...
      providers: [
        ...
        FormUtilsService,
        {
          ...
          useValue: {
            createRow: () => of({}),
            getPatology: () =>
              of({ values: [['Patologia 1'], ['Patologia 2']] }),
            getTreatments: () =>
              of({ values: [['Tratamento 1'], ['Tratamento 2']] }),
  ...
  it('should load patologies on init', () => {
    ...
    expect(component.patologies[0]).toBe('Patologia 1');
    expect(component.patologies[1]).toBe('Patologia 2');
